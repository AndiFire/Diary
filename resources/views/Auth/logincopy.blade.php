<section class=" min-h-screen flex items-center justify-center">
    <!-- login container -->
    <div class="bg-blue-200 dark:bg-zinc-800 flex rounded-xl shadow-lg max-w-4xl  items-center py-5">
      <!-- form -->
          <div class="md:w-1/2 md: max-w-sm px-8 md:px-16 ">
            ...
            <form action="" class="flex flex-col gap-4">
                ...
                <button class="bg-[#002D74] rounded-xl text-white py-2 hover:scale-105 duration-300">
                    <a class=" {{Route::is('home') ? 'active': ''}} " href="{{route('home')}}">{{__('Login')}}</a>
                </button>
            </form>
            ...
            <div class="mt-5 text-xs border-b border-[#002D74] pb-5 text-blue-500">
            <a href="#">Forgot your password?</a>
            </div>

            {{-- @if (Route::has('password.request'))
                <div class="mt-5 text-xs border-b border-[#002D74] pb-5 text-[#002D74]">
            ...
            <div class="mt-3 text-xs flex justify-between items-center text-blue-500">
                ...
                <button class="py-2 px-5 bg-white border rounded-xl hover:scale-110 duration-300 text-[#002D74]">Register</button>
            </div>
          </div>

          <!-- image -->
<!--        <div class="md:block w-1/2 bg">
            <div class="bg-cover bg-center " style="background-image: url('C:\OSPanel\domains\projects\Diary\public\images\login.jpg')"></div>
        </div> -->
    </div>
</section>
...
<div class="flex items-center justify-center min-h-screen ">
    ...
    >
      ...
      <div class="flex flex-col justify-center p-8 md:p-14">
        ...
        >
          <img src="..." alt="img" class="w-6 h-6 inline mr-2" />
          Sign in with Google
        </button>
