		...
		<div class="relative bg-bgColor dark:bg-bgColor-dark flex  rounded-2xl shadow-lg max-w-3xl  ">
		  ...
		  <!-- form -->
            ...
            @endif
				...
				<p class="text-xs mt-4  ">If you are already a member, easily log in</p>

				<!-- DATAS -->
				<form method="POST" action="{{ route('login') }}" class="flex flex-col gap-4">
					@csrf
                  <div>
                     <input class="w-full p-2 mt-8 rounded-xl border-2 dark:border-bgColor-dark border-bgColor  focus:border-2 focus:outline-none focus:ring-0 dark:bg-bgSecColor-dark bg-bgSecColor 
                     {{$errors->has('email') ? 'border-red-600 placeholder-red-600 focus:border-red-600' : 'focus:border-activeColor dark:focus:border-activeColor-dark'}}" 
                  ...
                  <div>
                     <div class="relative">
                        <div>
                           <input class="p-2 rounded-xl w-full border-2 dark:border-bgColor-dark border-bgColor  focus:border-2 focus:outline-none focus:ring-0  dark:bg-bgSecColor-dark bg-bgSecColor
                           {{$errors->has('password') ? 'border-red-600 placeholder-red-600 focus:border-red-600' : 'focus:border-activeColor dark:focus:border-activeColor-dark'}}" 
                  ...
                  <div class="flex items-center gap-2">
                     <input type="checkbox" id="remember" name="remember" class="ml-2 bg-bgSecColor dark:bg-bgSecColor-dark rounded cursor-pointer border-borderColor dark:border-borderColor-dark focus:outline-none focus:ring-0  ">
				...
				<div class="mt-6 grid grid-cols-3 items-center ">
					<hr class="border-gray-400">
						<h1 class="text-center text-sm">OR</h1>
					<hr class="border-gray-400">
				</div>
			...
			<div class="relative w-1/2 ">
               ...
               <img src="\images\diary-logo.png" class="mt-24" alt="Diary Logo">
