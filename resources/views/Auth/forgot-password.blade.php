...
<section class=" min-h-screen flex items-center justify-center">
    ...
    <div class="relative bg-blue-200  dark:bg-zinc-800 flex  rounded-2xl shadow-lg max-w-3xl  ">
        ...
        <div class="md:w-1/2 px-8 py-8 ">
            ...
            @if (session('status'))
                <div class="mb-4 flex items-center justify-center p-2 border border-2 rounded-xl border-green-400 bg-green-50">
            ...
            <h2 class="font-bold text-2xl text-blue-500">Forgot password</h2>
            <p class="text-xs mt-4 text-blue-500 ">If you forgot your password, easily send email </p>
